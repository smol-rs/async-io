...
#[cfg(not(any(feature = "io", feature = "timer")))]
mod driver_impl {
    use std::future::Future;
...
/// # Examples
///
#[cfg_attr(feature = "timer", doc = "```")]
#[cfg_attr(not(feature = "timer"), doc = "```no_compile")]
/// use async_io::Timer;
...
pub fn block_on<T>(future: impl Future<Output = T>) -> T {
    driver_impl::block_on(future)
}

#[cfg(any(feature = "io", feature = "timer"))]
pub(crate) use driver_impl::init;
